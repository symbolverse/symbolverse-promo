...
Symbolverse takes an **input of a workflow** described as symbolic expressions, interface declarations for each step/tool, and optional casts where uncertainty exists. After static analysis, Symbolverse produces the output of **structural confirmation** or **precise structural errors**. Structural errors may include missing capability, invalid projection, or incompatible interface, all caught before they show up at the runtime.
